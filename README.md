...
## Changements V21.3
- Faubourg des Ateliers plus dense avec les templates `workers` / `avenue` déjà éprouvés.
- Immeubles parisiens en pierre/crème/brique, y compris dans les quartiers populaires et industriels.
- Balcons/corniches étendus jusqu’à 5 niveaux sur les façades urbaines.
- Commerces parisiens intégrés dans des immeubles de 15 à 20 m au lieu de petits cubes isolés.
- Lampadaires boule avec 6 vraies lumières dynamiques maximum autour du joueur.
- Ombres douces, FOV plus cinématographique, aube plus lisible, arbres low-poly.
- Quêtes corrigées, paiement atomique corrigé, frustum culling des PNJ réactivé.
- Aucun override/réassignement des fonctions du générateur de chunks.
- Sauvegarde V21.3 dans `sq3d-v21.3` avec compatibilité V20.1.
